...
void oled_display()
{
	...
	switch(state)
	{
		...
		case 4:
		{
			...
			OLED_ShowString(0, 0, " MODE:02  TIMER ", 16);
		...
		case 6:
		{
			...
			OLED_ShowString(0, 0, " MODE:04  TIMER ", 16);
		...
		case 7:
		{
			...
			OLED_ShowString(0, 0, " MODE:05  TIMER ", 16);
		...
		case 8:
		{
			...
			OLED_ShowString(0, 0, " MODE:06  TIMER ", 16);
		...
		case 9:
		{
			...
			OLED_ShowString(0, 0, " MODE:07  TIMER ", 16);
			break;
		}
		default:
		{
